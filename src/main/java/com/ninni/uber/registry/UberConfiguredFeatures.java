...
public class UberConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapContext) {
        ...
        FeatureUtils.register(bootstapContext, PHASMOFUZZ_VEGETATION, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(UberBlocks.PHASMOFOLLICLE.defaultBlockState(), 4).add(UberBlocks.ISTALKS.defaultBlockState(), 7).add(UberBlocks.TALL_ISTALKS.defaultBlockState(), 1))));
        FeatureUtils.register(bootstapContext, PHASMOFUZZ_SURFACE, UberFeatures.GRYMMOTH_SURFACE, new VegetationPatchConfiguration(UberTags.BASE_STONE_GRYMMOTH, BlockStateProvider.simple(UberBlocks.PHASMOFUZZ), PlacementUtils.inlinePlaced(holderGetter.getOrThrow(PHASMOFUZZ_VEGETATION)), CaveSurface.FLOOR, ConstantInt.of(1), 0.0f, 5, 0.8f, UniformInt.of(4, 7), 0.3f));
    }
