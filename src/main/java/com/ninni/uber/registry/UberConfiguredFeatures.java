...
public class UberConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapContext) {
        ...
        FeatureUtils.register(bootstapContext, ELYSIAFUZZ_VEGETATION, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.AIR)));
        FeatureUtils.register(bootstapContext, PHASMOFUZZ_SURFACE, UberFeatures.GRYMMOTH_SURFACE, new UberSurfaceConfig(UberTags.PHASMOFUZZ_REPLACES, BlockStateProvider.simple(UberBlocks.PHASMOFUZZ), BlockStateProvider.simple(UberBlocks.MEDULESOIL), PlacementUtils.inlinePlaced(holderGetter.getOrThrow(PHASMOFUZZ_VEGETATION)), CaveSurface.FLOOR, ConstantInt.of(1), 0.0f, 5, 0.05F, UniformInt.of(4, 7), 0.3f));
        FeatureUtils.register(bootstapContext, ELYSIAFUZZ_SURFACE, UberFeatures.GRYMMOTH_SURFACE, new UberSurfaceConfig(UberTags.ELYSIAFUZZ_REPLACES, BlockStateProvider.simple(UberBlocks.ELYSIAFUZZ), BlockStateProvider.simple(UberBlocks.CROWNSTONE), PlacementUtils.inlinePlaced(holderGetter.getOrThrow(ELYSIAFUZZ_VEGETATION)), CaveSurface.FLOOR, ConstantInt.of(1), 0.0f, 5, 0.05F, UniformInt.of(4, 7), 0.3f));
