...
public class UberConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapContext) {
        ...
        FeatureUtils.register(bootstapContext, LAKE_MANA, Feature.LAKE, new LakeFeature.Configuration(BlockStateProvider.simple(UberBlocks.MANA.defaultBlockState()), BlockStateProvider.simple(UberBlocks.MEDULESOIL.defaultBlockState())));
    }
