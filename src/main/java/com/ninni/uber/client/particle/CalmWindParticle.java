...
public class CalmWindParticle extends SimpleAnimatedParticle {
    private final SpriteSet sprites;


    CalmWindParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
    ...
    public record Factory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel level, double d, double e, double f, double g, double h, double i) {
            return new CalmWindParticle(level, d, e, f, this.spriteSet);
        }
    }
}
